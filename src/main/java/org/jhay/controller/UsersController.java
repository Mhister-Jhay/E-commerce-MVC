...
import org.jhay.dto.ProductDTO;
import org.jhay.dto.StoreUsersDTO;
import org.jhay.model.User;
import org.jhay.service.impl.ProductServiceImpl;
    ...
    public String loginUser(@Validated StoreUsersDTO storeUsersDTO, Model model, HttpServletRequest httpServletRequest){
        if(storeUsersServiceImpl.findUserByEmail(storeUsersDTO.getEmail()) != null){
            ...
            if(isUserLoggedIn){
                ...
                if(user.getEmail().equals("admin@gmail.com") && user.getPassword().equals("adminpassword")){
